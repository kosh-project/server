...
/// # Parameters
///
/// - `$module` — A [`core::logger::Module`] variant identifying the subsystem emitting
///   the log.
...
///
/// This macro sends an entry with [`core::logger::Level::Shutdown`] and the
/// module hardcoded to [`core::logger::Module::Server`]. When the background
